...
class VnfLcmTest(base.BaseTackerTest):
    ...
    def setUpClass(cls):
        ...
        cls.vnf_package_5, cls.vnfd_id_5 = _create_and_upload_vnf_package(
            cls.tacker_client, "vnflcm5", {"key": "sample_5_functional"})
    ...
    def test_create_vnf_instance_and_instantiate_and_terminate_cnf_with_pod(
            self):
        """Test instantiation and heal API with instantiation level
        ...
        resp, vnf_instance = self._create_vnf_instance(self.vnfd_id_5,
                vnf_instance_name=vnf_instance_name,
                vnf_instance_description=vnf_instance_description)
        ...
        # generate body
        request_body = self._instantiate_vnf_request("simple",
                instantiation_level_id="instantiation_level_5",
                vim_id=self.vim_id)
